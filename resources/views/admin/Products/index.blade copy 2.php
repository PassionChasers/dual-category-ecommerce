...
@section('title', 'Tasks | Task Management')
    ...
    <div class="mb-6 flex justify-between items-center flex-wrap">
        ...
        <div class="flex flex-col md:flex-row md:justify-between md:items-center gap-2">
            ...
            <button id="new-task-button"
                class="w-full md:w-[140px] inline-flex items-center justify-center px-3 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none">
        ...
        <div class="overflow-x-auto">
            ...
            {{ $task->status == 0 ? 'bg-yellow-100 text-yellow-800' : ($task->status == 1 ? 'bg-blue-100 text-blue-800' : 'bg-green-100 text-green-800') }}"
                        ...
                        <td class="px-4 py-2 flex space-x-2">
                            ...
                            <a href="{{ route('task.showtask', $task) }}"
