                ...
                <tbody class="divide-y divide-gray-200">
                    {{-- @forelse($logs as $index => $log) --}}
                        <tr>
                            ...
                            <td class="px-4 py-2 font-semibold text-gray-800">abc</td>
                            <td class="px-4 py-2 text-gray-700">abc</td>
                            <td class="px-4 py-2 text-gray-600">abc</td>
                            <td class="px-4 py-2">
                                xxx
                            </td>
                            <td class="px-4 py-2">
                                @php
                                $statusColors = [
                                0 => ['Pending', 'bg-yellow-100 text-yellow-800'],
                                1 => ['In Progress', 'bg-blue-100 text-blue-800'],
                                2 => ['Completed', 'bg-green-100 text-green-800'],
                                ];
                                @endphp

                                <select
                                    class="status-select text-sm rounded px-2 py-1 border-none focus:ring-0">
                            ...
                            <td class="px-4 py-2 flex space-x-2">
                                ...
                                <button class="edit-btn text-indigo-600 hover:text-indigo-800" data-id="">
...
<!-- View Modal -->
<div id="view-log-modal" class="fixed z-20 inset-0 overflow-y-auto hidden">
    <div class="flex items-center justify-center min-h-screen px-4">
        <div class="fixed inset-0 bg-gray-500 opacity-75"></div>
        ...
        <div class="bg-white rounded-lg shadow-xl transform transition-all max-w-2xl w-full p-6 relative">
            ...
            <h3 class="text-lg font-semibold text-gray-900 mb-4">Log Details</h3>

            <div id="log-details" class="space-y-3 text-sm text-gray-700">
                ...
                <p><strong>Hours Spent:</strong> <span id="view-hours"></span></p>
                <p><strong>Description:</strong></p>
                <p class="bg-gray-50 p-2 rounded" id="view-description"></p>
                <p><strong>Created At:</strong> <span id="view-created"></span></p>
                <p><strong>Updated At:</strong> <span id="view-updated"></span></p>
            </div>
        </div>
    </div>
</div>
