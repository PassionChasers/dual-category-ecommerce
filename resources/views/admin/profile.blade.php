...
<div class="flex-1 overflow-auto p-4 md:p-6 bg-gray-50">
    ...
    <div class="bg-white shadow rounded-lg p-6">
        <form method="POST" enctype="multipart/form-data" action="#" id="profileForm"
            autocomplete="off">
            @csrf
            @method('PUT')
            ...
            <div class="flex flex-col items-center pb-6 border-b border-gray-200 mb-6">
                <div class="relative w-24 h-24 rounded-full overflow-hidden border-2 border-gray-200 bg-gray-100 flex items-center justify-center cursor-pointer"
                    ...
                    <img src="{{ asset(auth()->user()->employeeDetail->profile_picture) }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <input type="password" name="current_password" placeholder="Current Password" autocomplete="off"
                    class="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2" value="">
                <input type="password" name="password" placeholder="New Password" autocomplete="new-password"
                    class="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2" value="">
                <input type="password" name="password_confirmation" placeholder="Confirm Password"
                    autocomplete="new-password"
                    class="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2 md:col-span-2" value="">
            </div>

            <!-- Actions -->
            <div class="flex justify-end space-x-2 border-t pt-4">
                <button type="button" class="hidden px-4 py-2 bg-gray-100 border rounded-md hover:bg-gray-200">Cancel</button>
...
<script>
    ...
    //  Clear all password fields on page load
