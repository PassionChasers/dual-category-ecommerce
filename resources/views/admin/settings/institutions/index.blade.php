    ...
    <div class="mb-6 flex justify-between items-center flex-wrap">
        ...
        <div class="flex flex-col md:flex-row md:justify-between md:items-center gap-2 w-full md:w-auto">
            ...
            <button id="new-institution-button"
                class="iw-full md:w-[240px] inline-flex items-center justify-center px-3 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none"
                disabled>
...
<div id="institution-modal" class="fixed z-10 inset-0 overflow-y-auto hidden">
    <div class="flex items-center justify-center min-h-screen px-4">
        ...
        <div class="bg-white rounded-lg shadow-xl transform transition-all max-w-lg w-full p-6 relative">
            ...
            <form id="institution-form" method="get" class="space-y-4">
                @csrf
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.querySelectorAll('.edit-btn').forEach(btn => {
            btn.addEventListener('click', () => {
                ...
                form.action = `/settings/institutions/${btn.dataset.id}`;
