            ...
            <form method="POST" action="{{ route('settings.update', $setting->getKey()) }}" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="meta_description" class="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2">{{ old('meta_description', $setting->MetaDescription ?? '') }}</textarea>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    <div>
                        ...
                        <input type="url" name="facebook_url" id="facebook_url"
                            placeholder="https://facebook.com/yourpage" value="{{ $setting->FacebookUrl ?? '' }}"
                ...
                <div class="mb-6">
                    <label class="flex items-center space-x-2">
                        <input type="checkbox" name="maintenance_mode" value="1"
                            {{ old('maintenance_mode', $setting->MaintenanceMode ?? false) ? 'checked' : '' }}>
