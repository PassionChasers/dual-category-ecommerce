                                                 ...
                                                 <tr>
                                                     <td class="px-6 py-4 whitespace-nowrap">
                                                         <div class="flex items-center">
                                                             ...
                                                             <div class="ml-4">
                                                                 <div class="text-sm font-medium text-gray-900">Sarah
                                                                     Johnson</div>
                                                 ...
                                                 <tr>
                                                     <td class="px-6 py-4 whitespace-nowrap">
                                                         <div class="flex items-center">
                                                             ...
                                                             <div class="ml-4">
                                                                 <div class="text-sm font-medium text-gray-900">Michael Chen
                                                                 </div>
                                                 ...
                                                 <tr>
                                                     <td class="px-6 py-4 whitespace-nowrap">
                                                         <div class="flex items-center">
                                                             ...
                                                             <div class="ml-4">
                                                                 <div class="text-sm font-medium text-gray-900">David Wilson
                                                                 </div>
                                                 ...
                                                 <tr>
                                                     <td class="px-6 py-4 whitespace-nowrap">
                                                         <div class="flex items-center">
                                                             ...
                                                             <div class="ml-4">
                                                                 <div class="text-sm font-medium text-gray-900">Emily Brown
                                                                 </div>
                 ...
                 <div class="bg-white shadow rounded-lg overflow-hidden">
                     ...
                     <div class="p-6">
                         <form>
                             <div class="space-y-4">
                                 <div>
                                     <label for="report-type" class="block text-sm font-medium text-gray-700">Report
                                         Type</label>
                                 ...
                                 <div>
                                     <label for="time-period" class="block text-sm font-medium text-gray-700">Time
                                         Period</label>
