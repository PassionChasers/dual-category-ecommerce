...
<section class="bg-gray-50 min-h-screen py-16 px-6 md:px-20">
    <div class="max-w-4xl mx-auto text-center mb-12">
        <h1 class="text-4xl font-bold mb-4 text-primary-600">Support Center</h1>
    ...
    <div class="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-16">
        <!-- Account & Orders -->
        <div class="bg-white border border-gray-100 p-8 rounded-2xl shadow-md hover:shadow-xl hover:border-primary-400 transition text-center">
            <div class="w-14 h-14 bg-primary-100 text-primary-600 flex items-center justify-center rounded-full mx-auto mb-4">
                <i class="fas fa-user-circle text-2xl"></i>
            </div>
            <h3 class="font-semibold text-xl mb-2 text-gray-800">Account &amp; Orders</h3>
            <p class="text-gray-600 text-sm mb-3">
                Help with login, signup, profile updates, and viewing or managing your orders.
            </p>
            <a href="#" class="text-primary-600 font-medium hover:underline">Get Help</a>
        </div>
        ...
        <div class="bg-white border border-gray-100 p-8 rounded-2xl shadow-md hover:shadow-xl hover:border-primary-400 transition text-center">
            ...
            <h3 class="font-semibold text-xl mb-2 text-gray-800">Billing &amp; Payments</h3>
            <p class="text-gray-600 text-sm mb-3">
                Questions about payments, refunds, invoices, or failed transactions.
            </p>
            <a href="#" class="text-primary-600 font-medium hover:underline">Contact Billing</a>
        </div>
        ...
        <div class="bg-white border border-gray-100 p-8 rounded-2xl shadow-md hover:shadow-xl hover:border-primary-400 transition text-center">
            ...
            <h3 class="font-semibold text-xl mb-2 text-gray-800">Technical Support</h3>
            <p class="text-gray-600 text-sm mb-3">
                Having trouble with the website, checkout, or any feature? We’ll help you fix it.
            </p>
            <a href="#" class="text-primary-600 font-medium hover:underline">Troubleshoot</a>
        </div>
    </div>
    ...
    <div class="max-w-4xl mx-auto grid md:grid-cols-3 gap-6 text-center mb-16">
        <div class="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm">
            <h4 class="font-semibold mb-1 text-primary-600 text-sm uppercase tracking-wide">Response Time</h4>
            <p class="text-gray-600 text-sm">We usually respond within 24 hours on business days.</p>
        </div>
        <div class="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm">
            <h4 class="font-semibold mb-1 text-primary-600 text-sm uppercase tracking-wide">Order Help</h4>
            <p class="text-gray-600 text-sm">Keep your order ID handy so we can assist you faster.</p>
        </div>
        <div class="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm">
            <h4 class="font-semibold mb-1 text-primary-600 text-sm uppercase tracking-wide">Secure Support</h4>
    ...
    <div class="text-center max-w-xl mx-auto">
        ...
        <a href="{{ route('contact') }}"
           class="inline-block bg-gradient-to-r from-primary-500 to-primary-600 text-indigo-800 font-semibold py-3 px-10 rounded-full shadow-lg hover:opacity-90 transition duration-300">
            Contact Us
        </a>
    </div>
</section>
