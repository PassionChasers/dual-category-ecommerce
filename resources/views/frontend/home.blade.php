...
<section class="relative gradient-bg text-white py-20 flex items-center justify-center overflow-hidden" id="home">
    ...
    <div class="max-w-4xl mx-auto px-6 text-center relative z-10">
        ...
        <div class="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            ...
            <a href="#modules"
                class="bg-transparent border-2 border-white text-white px-6 py-4 rounded-lg font-semibold text-center hover:bg-white hover:bg-opacity-10 transition duration-300 flex items-center justify-center hover:text-indigo-800 hover:border-indigo-800">
