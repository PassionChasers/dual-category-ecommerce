...
@section('content')
    <!-- Hero Section -->
    <section
        class="relative bg-gradient-to-br from-orange-500   to-yellow-500 text-white py-20 flex items-center justify-center overflow-hidden"
        id="home">
        ...
        <div class="max-w-4xl mx-auto px-6 text-center relative z-10">
            ...
            <div class="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                ...
                <a href="{{ url('/login') }}"
                    class="px-8 py-4 rounded-lg font-bold text-center shadow-lg bg-white text-orange-600 transition-all duration-300 ease-in-out flex items-center justify-center group hover:bg-orange-50 hover:shadow-2xl transform hover:-translate-y-1">
                ...
                <a href="#modules"
                    class="bg-transparent border-2 border-white text-white px-8 py-4 rounded-lg font-bold text-center transition-all duration-300 flex items-center justify-center hover:bg-white hover:text-orange-500">
            ...
            <p class="mt-6 text-sm text-primary-100">
                Customers use one module at a time — Medical Supplier or Food Delivery — ensuring a focused, streamlined
                ordering flow.
            </p>
        </div>
    </section>
            ...
            <div class="flex flex-col md:flex-row items-center gap-12">
                <div class="md:w-1/2">
                    ...
                    <div class="grid items-center gap-4">
                        <div class="flex items-center bg-orange-100 rounded-lg pr-5 border-l-3 border-orange-500 py-1">
                            <div
                                class="w-10 h-10 rounded-full bg-orange-100 text-primary-600 flex items-center justify-center mr-3">
