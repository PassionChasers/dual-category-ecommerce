...
<section class="bg-gradient-to-br from-gray-900 to-gray-800 text-white min-h-screen py-16 px-6 md:px-20">
    ...
    <!-- Policy Content -->
    <div class="max-w-4xl mx-auto space-y-8 text-gray-300 leading-relaxed">
        ...
        <div>
            <h2 class="text-xl font-semibold text-primary-400 mb-2">3. Legal Basis & Sharing of Data</h2>
            <p class="mb-3">
        ...
        <div>
            <h2 class="text-xl font-semibold text-primary-400 mb-2">4. Data Protection & Retention</h2>
            <p class="mb-3">
        ...
        <div>
            <h2 class="text-xl font-semibold text-primary-400 mb-2">5. Cookies & Tracking Technologies</h2>
            <p class="mb-3">
        ...
        <!-- 6. Your Rights -->
        <div>
            <h2 class="text-xl font-semibold text-primary-400 mb-2">6. Your Rights</h2>
            <p class="mb-3">
        ...
        <div>
            <h2 class="text-xl font-semibold text-primary-400 mb-2">7. Updates to This Policy</h2>
            <p>
        ...
        <!-- 8. Contact Us -->
        <div>
            <h2 class="text-xl font-semibold text-primary-400 mb-2">8. Contact Us</h2>
            <p class="mb-3">
