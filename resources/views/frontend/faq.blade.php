...
@section('content')
    <section class="bg-gray-50 min-h-screen py-16 px-6 md:px-20">
        ...
        <div class="max-w-5xl mx-auto text-center mb-12 ">
            <h1 class="text-4xl md:text-5xl font-extrabold mb-4 text-primary-600">Frequently Asked Questions</h1>
        ...
        <div class="max-w-4xl mx-auto space-y-6">
            ...
            <details
                ...
                <div class="px-6 pb-5 text-gray-600 leading-relaxed border-t border-gray-100">
                    ...
                    protect your personal information and payment details. We never store full card information on our
                    servers.
                </div>
            </details>
            ...
            <details
                ...
                <div class="px-6 pb-5 text-gray-600 leading-relaxed border-t border-gray-100">
                    We currently provide delivery services in
                    <span class="font-medium text-primary-600">Biratnagar, Itahari,</span> and
                    <span class="font-medium text-primary-600">Dharan</span>.
                    We are actively expanding to more locations, so please stay tuned for updates.
                </div>
            </details>
        </div>
    </section>
