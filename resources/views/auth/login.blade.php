            ...
            <div class="px-8 py-6">
                ...
                <form class="mt-6 space-y-5" id="login-form" action="{{ route('login.authenticate') }}" method="POST"
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-sm">
                            <a href="{{route('forgot-password')}}" class="font-medium text-indigo-800 hover:text-indigo-500">
                                Forgot password?
                            </a>
                        </div>
                    </div>
                    ...
                    <div>
                        <button type="submit"
                            class="w-full py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-orange-500 hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-offset-2 transition">
                            Log In
                        </button>
                    </div>
                </form>
